...
# 读取系统提示
with open("/root/autodl-tmp/EasyEdu/src/agents/prompts/knowledge_point_summry_promot.txt", "r", encoding="utf-8") as f:
    system_prompt = f.read()

# 读取知识点数据
with open("/root/autodl-tmp/EasyEdu/data/ds_data/knowledgepoints/all_knowledgepoints.json", "r", encoding="utf-8") as f:
...
for batch_idx, batch_range in enumerate(batches):
    ...
    # 每批次结束后保存结果
    with open("/root/autodl-tmp/EasyEdu/data/ds_data/knowledgepoints/all_knowledgepoints.json", "w", encoding="utf-8") as f:
